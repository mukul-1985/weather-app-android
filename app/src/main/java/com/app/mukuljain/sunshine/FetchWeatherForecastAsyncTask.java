...
public class FetchWeatherForecastAsyncTask extends AsyncTask<String, Void, String[]> {
    ...
    protected void onPostExecute(String[] result) {
        if (result != null && mArrayAdapter != null) {
            mArrayAdapter.clear();
    ...
    private String getReadableDateString(long dateTime) {
        ...
        SimpleDateFormat shortendDateFormat = new SimpleDateFormat("E, MMM d");
        return shortendDateFormat.format(date).toString();
    }
    ...
    /*
        This code will allow this class to continue to return the strings that
