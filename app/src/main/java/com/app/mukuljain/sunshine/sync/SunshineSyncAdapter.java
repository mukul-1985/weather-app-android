package com.app.mukuljain.sunshine.sync;
...
import com.app.mukuljain.sunshine.BuildConfig;
import com.app.mukuljain.sunshine.MainActivity;
import com.app.mukuljain.sunshine.R;
import com.app.mukuljain.sunshine.Utility;
...
/**
 * Created by mukuljain on 10/29/2015.
 */
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            // if the code didn't successfully get data, there's not point in attempting to parse it.
            setLocationStatus(getContext(), LOCATION_STATUS_SERVER_DOWN);
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        // First check if the location with this city name exist in db
    ...
    /**
     * sets the location status into SharedPreference. This function should not be called from UI
     * thread because it uses commit to write to the SharedPreference.
     *
